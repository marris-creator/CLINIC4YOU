  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 h-full flex flex-col justify-end min-h-[160px]">
        ...
        />
        <h3 className="font-display text-teal-100 text-lg leading-tight mb-1">{item.label}</h3>
      ...
      <div className="container-xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-14 items-end">
          ...
          >
            ...
            <h2 id="gallery-heading" className="font-display text-3xl md:text-5xl text-teal-100 text-balance leading-tight">
              A Space Built for Your <em className="not-italic text-teal-300">Comfort</em>
            </h2>
          </motion.div>

          <motion.p
            className="text-teal-200 text-lg leading-relaxed text-pretty self-end"
            initial="hidden"
            whileInView="visible"
            viewport={VIEWPORT}
