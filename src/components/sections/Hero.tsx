  ...
  return (
    ...
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.h1
              custom={0.1}
              variants={heroLine}
              className="font-display text-5xl md:text-6xl lg:text-7xl text-teal-100 leading-[1.08] mb-6 text-balance"
            >
              Your Smile,{" "}
            ...
            <motion.p
              custom={0.25}
              variants={heroLine}
              className="text-teal-200 text-lg md:text-xl leading-relaxed mb-10 max-w-lg text-pretty"
            >
            ...
            >
              ...
              <a
                ...
                className="flex items-center gap-2 border-2 border-teal-400/60 hover:border-teal-300 text-teal-100 hover:text-teal-50 font-semibold px-6 py-4 rounded-2xl text-base backdrop-blur-sm transition-all duration-200 active:scale-[0.97]"
              >
                <Phone size={18} />
                {CLINIC.phone}
              </a>
            ...
            <motion.div custom={0.5} variants={heroLine} className="flex flex-wrap gap-3">
              {TRUST_BADGES.map((badge) => (
                ...
                >
                  ...
                  <div>
                    <div className="text-teal-100 text-sm font-semibold leading-none">
                      {badge.label}
                    </div>
                    <div className="text-teal-300 text-2xs mt-0.5">{badge.sub}</div>
                  </div>
                </div>
              ))}
            </motion.div>
              ...
              <div className="aspect-[4/3] rounded-2xl overflow-hidden relative bg-gradient-to-br from-navy-800 via-navy-700 to-teal-900">
                <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-1 p-1">
                  ...
                  <div className="rounded-xl bg-navy-600/50 flex items-end p-3">
                    <span className="text-teal-100 text-xs font-semibold">Aesthetic Room</span>
                  </div>
                  <div className="rounded-xl bg-navy-700/40 flex items-end p-3">
                    <span className="text-teal-100 text-xs font-semibold">Reception</span>
                  </div>
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <span className="text-teal-300 text-xs tracking-widest uppercase">Scroll</span>
        <motion.div
          className="w-5 h-8 border-2 border-teal-500/40 rounded-full flex items-start justify-center pt-1.5"
