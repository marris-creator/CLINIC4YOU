    ...
    <section className="section-padding bg-gradient-section">
      <div className="container-xl">
        <div className="grid md:grid-cols-2 gap-6">
          {/* PRSI Benefit card */}
          <div className="bg-white rounded-3xl p-8 shadow-card border border-sand-100 flex gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-navy-500 leading-relaxed mb-4">
                Eligible PAYE workers can claim a free dental exam and subsidised treatments
                each year. Bring your PPS number — we'll check your entitlement on the spot.
              </p>
              <div className="flex flex-wrap gap-2 mb-5">
                {["Free Exam", "Scale & Polish", "X-Rays"].map((b) => (
                  <span key={b} className="text-xs bg-blue-50 text-blue-700 border border-blue-100 px-3 py-1 rounded-full font-medium">
                    {b}
                  </span>
                ))}
              </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-card border border-sand-100 flex gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-navy-500 leading-relaxed mb-4">
                Spread the cost of your treatment over manageable monthly instalments with
                Humm finance. No large upfront payment required.
              </p>
              <div className="flex flex-wrap gap-2 mb-5">
                {["0% options", "Fast approval", "All treatments"].map((b) => (
                  <span key={b} className="text-xs bg-teal-50 text-teal-700 border border-teal-100 px-3 py-1 rounded-full font-medium">
                    {b}
                  </span>
                ))}
              </div>
