        ...
        >
          ...
          <div className="inline-flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl px-6 py-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs mt-1">{CLINIC.reviewCount}+ Google Reviews</p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="relative bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 overflow-hidden min-h-[260px]">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <blockquote className="font-display text-lg md:text-xl text-slate-200 leading-relaxed mb-8 italic text-balance">
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <motion.button
                      ...
                      className="w-9 h-9 rounded-xl bg-white/10 hover:bg-teal-600 flex items-center justify-center transition-colors text-slate-200"
                    >
                      <ChevronLeft size={18} />
                    </motion.button>
                    <motion.button
