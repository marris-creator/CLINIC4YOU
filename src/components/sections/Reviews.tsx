    ...
    >
      ...
      <div className="container-xl relative z-10">
        ...
        >
          ...
          <h2 id="reviews-heading" className="font-display text-3xl md:text-4xl text-teal-100 mb-4">
            What Our Patients Say
          </h2>
          <div className="inline-flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl px-6 py-3">
            <div>
              <span className="font-display text-teal-100 text-3xl">{CLINIC.rating}</span>
              <span className="text-teal-200 text-sm ml-1">/ 5</span>
            </div>
            <div>
              <StarRating rating={CLINIC.rating} size={20} />
              <p className="text-teal-200 text-xs mt-1">{CLINIC.reviewCount}+ Google Reviews</p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="relative bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 overflow-hidden min-h-[260px]">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <blockquote className="font-display text-lg md:text-xl text-teal-100 leading-relaxed mb-8 italic text-balance">
                  &ldquo;{TESTIMONIALS[active].text}&rdquo;
                </blockquote>
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    <cite className="not-italic font-semibold text-teal-100">
                  ...
                  <div className="flex items-center gap-2">
                    <motion.button
                      ...
                      className="w-9 h-9 rounded-xl bg-white/10 hover:bg-teal-600 flex items-center justify-center transition-colors text-teal-100"
                    >
                      <ChevronLeft size={18} />
                    </motion.button>
                    <motion.button
